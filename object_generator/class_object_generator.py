            ...
            if conn:
                ...
                try:
                    ...
                    if pg_action and object_params_dict:
                        if pg_action == 'insert':
                            sql = 'insert into object_list_test_all ' + str(tuple(object_params_dict.keys())).replace('\'', '') + ' values ' + str(tuple(object_params_dict.values())).replace('u\'', '\'')
                            print sql
                            cur.execute(sql)
                            conn.commit()
                            ...
                            if pg_action == 'select':
                                sql = 'select * from object_list_test_all where ' + condition
                            else:
                                sql = 'delete from object_list_test_all where ' + condition
